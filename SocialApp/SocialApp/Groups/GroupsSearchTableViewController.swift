...
class GroupsSearchTableViewController: UITableViewController {
    ...
    let groupsArray: [String] = ["Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup", "Searched goup"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.groupImage.image = UIImage(named: "users")
